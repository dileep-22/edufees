import { r as reactExports, j as jsxRuntimeExports, c as cn, S as Skeleton, b as useNavigate } from "./index-Bb6f_FCk.js";
import { C as ChevronDown, B as Building2, b as CreditCard, U as Users, L as Layout, P as PageHeader } from "./badge-BagwGDur.js";
import { u as useDirection, a as useControllableState, P as Primitive, b as useId, c as composeEventHandlers, d as createContextScope } from "./Combination-BTsKCupS.js";
import { R as Root, I as Item, c as createRovingFocusGroupScope } from "./index-BLPLWcsf.js";
import { P as Presence } from "./index-BaoaRZan.js";
import { C as CurrencyDisplay, E as EmptyState, D as DataTable } from "./EmptyState-CA2NJPcu.js";
import { c as createLucideIcon, B as Button, P as PaymentStatus, b as PaymentMethod } from "./backend-CvGl-pMz.js";
import { C as Card, c as CardContent, a as CardHeader, b as CardTitle } from "./card-Qs2UClye.js";
import { b as useAgingReport, c as useAgingReportDetail, d as usePayments, u as useCollectionSummary, e as usePaymentMethodBreakdown } from "./use-payments-9ZgJc-fZ.js";
...
function DrillDownTable({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 p-4", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full" }, i)) });
  }
  if (details.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground px-4 py-6 text-center", children: "No records found for this bucket." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Student Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Student ID" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Fee Structure" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Days Overdue" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Amount Due" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Amount Paid" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Outstanding" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: details.map((item, idx) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-foreground", children: item.studentName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-xs text-muted-foreground", children: item.studentId }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: item.feeStructureName }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CurrencyDisplay, { amount: item.amountDue, size: "sm" }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-lg overflow-hidden", children: [
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-4 h-4 text-muted-foreground shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 text-muted-foreground shrink-0" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Overdue Fees" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-foreground", children: bucket.count.toString() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right min-w-[100px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Total Overdue" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                CurrencyDisplay,
                {
    ...
    isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("bg-secondary/20"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          DrillDownTable,
          {
...
function AgingReportTab() {
  ...
  const [expandedBucket, setExpandedBucket] = reactExports.useState(null);
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Failed to load aging report" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 opacity-80", children: "Unable to retrieve overdue data. Please refresh the page or try again. Ensure you are signed in with admin access." })
          ] })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border border-border shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Click a bucket to drill down into individual overdue payments" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-lg" }, i)) }) : !hasData ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        EmptyState,
        {
          icon: TriangleAlert,
          title: "No aging data",
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: buckets.map((bucket) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        AgingBucketRow,
        {
          bucket,
...
function CollectionsSummaryTab() {
  ...
  const isZeroData = !summaryLoading && summary !== void 0 && summary.totalCollected === 0n && summary.totalOutstanding === 0n && summary.totalOverdue === 0n && summary.paymentCount === 0n;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "collections-summary-tab", children: [
    (summaryError || paymentsError) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex items-start gap-3 rounded-lg border border-destructive/40 bg-destructive/10 px-4 py-3 text-sm text-destructive",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Failed to load data" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 opacity-80", children: "Unable to retrieve report data. Please refresh the page or try again. If the issue persists, ensure you are signed in with admin access." })
          ] })
        ]
      }
    ),
    ...
    isZeroData ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border border-border shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        icon: TrendingUp,
    ...
    isError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Failed to load payment methods data" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 opacity-80", children: "Unable to retrieve payment breakdown. Please refresh the page or try again. Ensure you are signed in with admin access." })
          ] })
        ]
      }
    ),
...
function StudentBalancesTab() {
  ...
  const totalPenalties = reactExports.useMemo(
    ...
    ...hasPenalties ? [
      {
        key: "penaltyAmount",
        header: "Penalties",
        render: (b) => b.penaltyAmount > 0n ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          CurrencyDisplay,
          {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "student-balances-tab", children: [
    isError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex items-start gap-3 rounded-lg border border-destructive/40 bg-destructive/10 px-4 py-3 text-sm text-destructive",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Failed to load student balances" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 opacity-80", children: "Unable to retrieve balance data. Please refresh the page or try again. Ensure you are signed in with admin access." })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border border-border shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 space-y-4", children: [
      ...
      !isLoading && hasPenalties && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-3 border-t border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Total Penalties (shown above)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CurrencyDisplay,
          {
