import { r as reactExports, j as jsxRuntimeExports, b as useNavigate } from "./index-Bb6f_FCk.js";
import { u as ue, L as Layout, P as PageHeader, U as Users, d as Badge } from "./badge-BagwGDur.js";
import { D as DataTable, E as EmptyState, C as CurrencyDisplay } from "./EmptyState-CA2NJPcu.js";
import { c as createLucideIcon, B as Button } from "./backend-CvGl-pMz.js";
...
import { b as useBulkImportStudents, a as useStudents, u as useAllBalances, c as useCreateStudent, d as useUpdateStudent, e as useDeleteStudent } from "./use-students-DOaJ0Z6A.js";
...
import { a as useAssignFeeToGroup } from "./use-assignments-DnGPXMwb.js";
...
function ImportResultView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `flex items-start gap-3 rounded-lg p-4 ${hasErrors ? "bg-amber-50 border border-amber-200" : "bg-emerald-50 border border-emerald-200"}`,
        "data-ocid": "import-result-banner",
        children: [
          hasErrors ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-5 h-5 text-amber-600 shrink-0 mt-0.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5 text-emerald-600 shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: `font-semibold text-sm ${hasErrors ? "text-amber-800" : "text-emerald-800"}`,
                children: hasErrors ? `${outcome.imported} row${outcome.imported !== 1 ? "s" : ""} imported successfully, ${outcome.errors.length} row${outcome.errors.length !== 1 ? "s" : ""} had errors` : `All ${outcome.imported} student${outcome.imported !== 1 ? "s" : ""} imported successfully`
              }
            ),
            hasErrors && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-700 mt-0.5", children: "Valid rows were imported. The rows below were rejected by the server." })
          ] })
        ]
      }
    ),
    hasErrors && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-destructive/20 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-destructive/5 px-3 py-2 border-b border-destructive/20 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-3.5 h-3.5 text-destructive" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-destructive uppercase tracking-wide", children: [
          "Import Errors (",
          outcome.errors.length,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto max-h-56 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", "data-ocid": "import-error-table", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left font-semibold text-muted-foreground w-14", children: "Row #" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left font-semibold text-muted-foreground w-24", children: "Field" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left font-semibold text-muted-foreground", children: "Value" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left font-semibold text-muted-foreground", children: "Error" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: outcome.errors.map((err) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center justify-center w-6 h-6 rounded bg-destructive/15 text-destructive font-bold", children: Number(err.row) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 font-mono text-muted-foreground", children: err.field || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 font-mono text-foreground max-w-[120px] truncate", children: err.value || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 text-destructive", children: err.message })
            ]
          },
          `${Number(err.row)}-${err.field}`
        )) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", onClick: onClose, "data-ocid": "import-done-btn", children: "Done" }) })
  ] });
}
function CsvImportModal({
  ...
  const [importOutcome, setImportOutcome] = reactExports.useState(
    null
  );
  ...
  const handleImport = () => {
    ...
    bulkImport.mutate(payload, {
      onSuccess: (result) => {
        ...
        setCsvText("");
        if (errors.length === 0) {
          ue.success(`${count} student${count !== 1 ? "s" : ""} imported`);
        } else {
          ue.warning(`${count} imported, ${errors.length} had errors`);
        }
      },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto space-y-4 py-2", children: importOutcome !== null ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ImportResultView,
          {
        ...
        importOutcome === null && /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "border-t border-border pt-4 mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
          ...
          !isPreviewing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          DataTable,
          {
            ...
            emptyState: search || groupFilter !== "all" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              EmptyState,
              {
                icon: Users,
