...
import { i as Subscribable, s as shallowEqualObjects, k as hashKey, l as getDefaultState, n as notifyManager, d as useQueryClient, r as reactExports, m as noop, o as shouldThrowError, R as React2, h as ReactDOM, j as jsxRuntimeExports, p as useRouterState, L as Link, c as cn, u as useInternetIdentity, a as useRouter } from "./index-Bb6f_FCk.js";
import { c as createLucideIcon, G as GraduationCap, S as Slot, i as cva } from "./backend-CvGl-pMz.js";
...
const CircleHelp = createLucideIcon("circle-help", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Sidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-5 h-14 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-4 h-4 text-primary-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground truncate", children: "EduAdmin" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 px-3 py-4 space-y-0.5 overflow-y-auto", children: navItems.map(({ to, label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavLink,
          {
            to,
            label,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-3 border-t border-border space-y-0.5", children: bottomItems.map(({ to, label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavLink,
          {
            to,
            label,
...
function Layout({ children }) {
  ...
  const principalText = identity ? truncatePrincipal(identity.getPrincipal().toText()) : "Admin";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0 overflow-hidden", children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-md bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-3.5 h-3.5 text-primary-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-semibold text-foreground", children: "EduFees" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-border", children: "|" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Westfield Academy" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-primary bg-primary/10 px-2 py-0.5 rounded-md font-medium", children: "Admin" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-1 w-1.5 h-1.5 bg-accent rounded-full" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", ref: menuRef, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    "aria-haspopup": "menu",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-primary/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleUser, { className: "w-4 h-4 text-primary" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "font-medium text-foreground text-xs hidden sm:block max-w-[120px] truncate",
                          title: identity == null ? void 0 : identity.getPrincipal().toText(),
                ...
                menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pt-3 pb-2.5 border-b border-border", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-2", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleUser, { className: "w-5 h-5 text-primary" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground", children: "Administrator" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Internet Identity" })
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary rounded-md px-2.5 py-1.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5 font-medium", children: "Principal ID" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "p",
                              {
                                className: "text-xs font-mono text-foreground truncate",
                                title: identity == null ? void 0 : identity.getPrincipal().toText(),
                                children: (identity == null ? void 0 : identity.getPrincipal().toText()) ?? "—"
                              }
                            )
                          ] })
                        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "main",
        {
          ...
          children: [
            children,
            /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "px-6 py-4 border-t border-border bg-muted/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "© ",
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-display font-semibold text-foreground truncate", children: title }),
          description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: description })
        ] }),
        children && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 shrink-0", children })
      ]
    }
  );
}
